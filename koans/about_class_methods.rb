...
class AboutClassMethods < Neo::Koan
  ...
  # A: the second way looks more cryptic, IMHO, though a nice use case for it
  # would be when defining multiple class methods, so prefixing each one with 
  # `self.` would be a littly too much. 
