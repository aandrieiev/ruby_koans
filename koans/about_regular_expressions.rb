...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # A: When the preceeding char doesn't match:
    # 'ab'['/cd*/']
  end
  ...
  #
  # Why?
  # A: Because they try to match as many chars as possible
  ...
  # A: ... matches try chars, | allows to match any of two patterns between
  # which it is put
