...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answers: it accepts an initial value of accumulator and then stores
    # the results of block evaluation into it 
  end
  ...
  # Answer: Because when passing a block to it, the file descriptor is closed 
  # in the body of ::open without additional actions required from the user
